...
public class DictionariesService {
    ...
    private List<DictionaryData> getGender(Language lang) {
        return Language.PL == lang ?
    ...
    private List<DictionaryData> getCatteryStatuses(Language lang) {
    ...
    private List<DictionaryData> getWebsiteVisibilityStatuses(Language lang) {
        List<DictionaryData> list = new ArrayList<>();
    ...
    private List<DictionaryData> getTransactionStatuses(Language lang) {
        List<DictionaryData> list = new ArrayList<>();
    ...
    private List<DictionaryData> getSaleStatuses(Language lang) {
        List<DictionaryData> list = new ArrayList<>();
    ...
    private List<DictionaryData> getSpecies(Language lang) {
    ...
    private List<DictionaryData> getBreeds(Language lang) {
    ...
    private List<DictionaryData> getBirths(Language lang) {
    ...
    private List<DictionaryData> getAnimalParents(Language lang, DictionaryType type) {
    ...
    private List<DictionaryData> getDictionaryDataSpecies(Language lang, Iterable<Species> species) {
    ...
    private List<DictionaryData> getDictionaryDataBreeds(Language lang, Iterable<Breed> breeds) {
        List<DictionaryData> data = new ArrayList<>();
    ...
    private List<DictionaryData> getDictionaryDataBirths(Language lang, Iterable<Birth> births) {
        List<DictionaryData> data = new ArrayList<>();
    ...
    private List<DictionaryData> getDictionaryDataWithAnimals(Language lang, Iterable<Animal> animals) {
        List<DictionaryData> data = new ArrayList<>();
