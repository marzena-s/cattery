...
import pl.com.kocielapki.cattery.cattery.config.CatteryConfig;
...
public class ImageService {
    private CatteryConfig catteryConfig;
    ...
    public ImageService(CatteryConfig catteryConfig, ImageRepository imageRepository, ApplicationConfig applicationConfig) {
        this.catteryConfig = catteryConfig;
    ...
    public String saveImageOnServer(MultipartFile imageFile) {
        try {
            ...
            Path path = Paths.get(catteryConfig.getPathToGallery() + fileName);
